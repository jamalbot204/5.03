...
const markdownRenderers = {
    code({ node, inline, className, children, ...props }: any) {
        ...
        if (!inline && match && isStreaming) {
            return (
                <div className="my-2 rounded-md border border-[var(--aurora-border)] bg-[var(--aurora-code-bg)] p-4 overflow-x-auto">
                    <span className="text-xs text-gray-500 font-mono mb-2 block animate-pulse">Generating code...</span>
                    <pre className="text-sm text-gray-300 font-mono m-0"><code>{codeString}</code></pre>
                </div>
            );
        }
