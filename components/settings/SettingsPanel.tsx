...
const SettingsPanel: React.FC = memo(() => {
    ...
    const [editingInstructionType, setEditingInstructionType] = useState<'systemInstruction' | 'userPersonaInstruction' | 'customReminderMessage' | 'enhancedThinkingJudgeInstruction' | null>(null);
    ...
    const handleOpenInstructionModal = useCallback((type: 'systemInstruction' | 'userPersonaInstruction' | 'customReminderMessage' | 'enhancedThinkingJudgeInstruction') => {
