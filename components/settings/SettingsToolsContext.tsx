...
interface SettingsToolsContextProps {
  ...
  onOpenInstructionModal: (type: 'customReminderMessage' | 'enhancedThinkingJudgeInstruction') => void;
}
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative p-4 rounded-r-xl rounded-l-md border border-white/10 border-l-4 border-l-indigo-500 bg-gradient-to-r from-indigo-500/5 to-transparent">
        ...
        <div className="flex flex-col pl-1 mb-4 border-b border-indigo-500/10 pb-4">
          <div className="flex items-center justify-between mb-1">
            <label htmlFor="enhancedThinkingMode" className="block text-sm text-indigo-200 font-medium">
                {t.enhancedThinkingMode}
            </label>
            <select
                id="enhancedThinkingMode"
                name="enhancedThinkingMode"
                className="p-1.5 aurora-select text-xs border-indigo-500/30 focus:border-indigo-500 rounded bg-black/40 text-gray-200"
          ...
          {(localSettings.enhancedThinkingMode === 'judge' || localSettings.enhancedThinkingMode === 'fusion') && (
             <div className="ml-6 mt-3 animate-fade-in">
                 <div className="flex justify-between items-center mb-1">
                     <label className="block text-xs font-medium text-indigo-300 flex items-center">
                     ...
                     <button 
                         ...
                         className="text-[10px] text-indigo-400 hover:text-indigo-200 flex items-center transition-colors"
                     >
                 ...
                 <div 
                     className="w-full p-2 bg-black/20 border border-indigo-500/20 rounded-md text-[10px] text-gray-400 truncate cursor-pointer hover:border-indigo-500/50 transition-colors"
                     onClick={() => onOpenInstructionModal('enhancedThinkingJudgeInstruction')}
                 >
